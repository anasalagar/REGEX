...
namespace Regex_Last_Name_UC2
{
    class check  //create one class.
    {
        ...
        /*public static void password(string pass)            //declaring the static meythod to take user input.
        {
            string word = "^[A-Za-z0-9]{8,}$";
            ...
            {
                Console.WriteLine("Password is invalid ,please write minimum 8 characters");
                Console.ReadLine();
            }
        ...
        */
        /*public static void password(string pass)            //declaring the static meythod to take user input.
        {
            ...
            {
                Console.WriteLine("Password is invalid ,please write first word in uppercase");
                Console.ReadLine();
            }
         }*/
